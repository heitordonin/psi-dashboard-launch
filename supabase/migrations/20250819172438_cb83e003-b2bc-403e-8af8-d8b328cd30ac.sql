-- Migration 1: RPC Overload Fix + Index

-- 1) Renomeia a função com p_month para eliminar PGRST203
ALTER FUNCTION public.get_monthly_whatsapp_count(p_user_id uuid, p_month date)
RENAME TO get_monthly_whatsapp_count_by_month;
...
-- 3) Versão por mês explícito (mantida, agora com nome novo e predicado por faixa)
